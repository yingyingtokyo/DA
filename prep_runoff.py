...
def prepare_input():
    ...
    """
    if os.path.islink("./CaMa_in_"+pm.runname(pm.mode())+"/inp"):
        os.system("rm -r ./CaMa_in_"+pm.runname(pm.mode())+"/inp")
    os.system("ln -sf "+pm.runoff_dir()+" ./CaMa_in_"+pm.runname(pm.mode())+"/inp")
    return 0
######################################
