...
def prepare_obs():
    ...
    if os.path.islink("./assim_"+pm.runname(pm.mode())+dahour_str+"/obs"):
        os.system("rm -rf ./assim_"+pm.runname(pm.mode())+dahour_str+"/obs")
    os.system("ln -sf "+pm.obs_dir()+" ./assim_"+pm.runname(pm.mode())+dahour_str+"/obs")
    return 0
####################################
